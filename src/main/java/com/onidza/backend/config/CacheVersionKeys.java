...
public final class CacheVersionKeys {
    ...
    public static final String COUPONS_PAGE_BY_CLIENT_ID_VER_KEY = "coupons:byClientId:ver";
    ...
    public static final String ORDERS_PAGE_BY_CLIENT_ID_VER_KEY = "orders:byClientId:ver";
